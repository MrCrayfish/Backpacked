...
public final class ModBlocks
{
    ...
    public static final RegistryEntry<Block> BACKPACK_DOCK = RegistryEntry.blockWithItem(new ResourceLocation(Constants.MOD_ID, "backpack_dock"), () -> new BackpackDockBlock(Block.Properties.copy(Blocks.OAK_PLANKS)));
}
