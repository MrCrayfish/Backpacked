...
public final class ModBlocks
{
    ...
    public static final RegistryEntry<Block> BACKPACK_DOCK = RegistryEntry.blockWithItem(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "backpack_dock"), () -> new BackpackDockBlock(Block.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
}
