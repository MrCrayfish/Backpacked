...
public record WaveformValue(Waveform waveform, double wavelength, double amplitude, double phase) implements Value
{
    public static final Type TYPE = new Type(
        Utils.rl("waveform"),
        RecordCodecBuilder.<WaveformValue>create(builder -> builder.group(
    ...
    public enum Waveform implements StringRepresentable
    {
        ...
        public static final EnumCodec<Waveform> CODEC = StringRepresentable.fromEnum(Waveform::values);
