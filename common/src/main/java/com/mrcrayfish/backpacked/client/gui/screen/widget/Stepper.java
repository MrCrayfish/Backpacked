...
public class Stepper extends AbstractWidget // TODO DONE
{
    ...
    {
        TextureDefinitions.STEPPER_BACKGROUND.draw(graphics, this.getX() + this.getHeight(), this.getY() + 1, this.getWidth() - this.getHeight() * 2, this.getHeight() - 2);

        boolean leftHovered = this.isDecrementHovered(mouseX, mouseY);
        BUTTON_SPRITES.get(true, leftHovered).draw(graphics, this.getX(), this.getY(), this.getHeight(), this.getHeight());
        TextureDefinitions.STEPPER_PREVIOUS.draw(graphics, this.getX() + (this.getHeight() - 4) / 2, this.getY() + (this.getHeight() - 6) / 2, 4, 6);

        boolean rightHovered = this.isIncrementHovered(mouseX, mouseY);
        BUTTON_SPRITES.get(true, rightHovered).draw(graphics, this.getX() + this.getWidth() - this.getHeight(), this.getY(), this.getHeight(), this.getHeight());
        TextureDefinitions.STEPPER_NEXT.draw(graphics, this.getX() + this.getWidth() - this.getHeight() + (this.getHeight() - 4) / 2, this.getY() + (this.getHeight() - 6) / 2, 4, 6);
