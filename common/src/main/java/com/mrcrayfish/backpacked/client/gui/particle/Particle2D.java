...
public class Particle2D
{
     ...
     *
     * @param u      the start u of the texture
     * @param v      the start v of the texture
     * @param width  the width of the texture
     * @param height the height of the texture
     * @param source the location to the texture
     * @return this Particle2D instance
     */
    public Particle2D setSprite(ResourceLocation source, int u, int v, int width, int height)
    {
        this.u1 = u;
        this.v1 = v;
        this.u2 = u + width;
    ...
    public void render(GuiGraphics graphics, float partialTick)
    {
        ...
        pose.translate(-this.width / 2, -this.height / 2, 0);
        float u1 = this.u1 / 256F;
        float v1 = this.v1 / 256F;
        float u2 = this.u2 / 256F;
        float v2 = this.v2 / 256F;
        ...
        builder.vertex(matrix, 0, (float) this.height, 0).uv(u1, v2).endVertex();
        builder.vertex(matrix, (float) this.width, (float) this.height, 0).uv(u2, v2).endVertex();
        builder.vertex(matrix, (float) this.width, 0, 0).uv(u2, v1).endVertex();
