...
{
    public static final Type TYPE = new Type(ResourceLocation.withDefaultNamespace("expression"), RecordCodecBuilder.<ExpressionValue>mapCodec(builder -> builder.group(
