...
public class LightweaverMenu extends AugmentSettingsMenu
{
    ...
    public LightweaverMenu(PopupMenuHandler handler, AugmentHolder<LightweaverAugment> holder)
    {
        super(handler, menu -> {
            ...
            rootHelper.addChild(createOption(LIGHT_LEVEL_LABEL, LIGHT_LEVEL_TOOLTIP, Stepper.builder()
                .setSize(60, 18)
            ...
            rootHelper.addChild(createOption(PLACE_SOUND_LABEL, PLACE_SOUND_TOOLTIP, BackpackButtons.onOff(() -> {
