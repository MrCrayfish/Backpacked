 ...
 * Author: MrCrayfish
 */
public record ScaleMatrixFunction(Value x, Value y, Value z) implements BaseFunction // TODO DONE
{
    public static final Type TYPE = new Type(
        Utils.rl("scale_matrix"),
        RecordCodecBuilder.<ScaleMatrixFunction>create(builder -> builder.group(
