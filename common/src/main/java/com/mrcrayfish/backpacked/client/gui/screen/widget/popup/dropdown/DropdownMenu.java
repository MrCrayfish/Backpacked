...
public class DropdownMenu extends PopupMenu // TODO DONE
{
    ...
    public static class Builder
    {
        ...
        private @Nullable FrameworkTexture background = TextureDefinitions.DROPDOWN_BACKGROUND;
        ...
        public Builder setBackground(@Nullable FrameworkTexture background)
        {
        ...
        public DropdownMenu build()
        {
            ...
            this.items.forEach(item -> {
                item.setWidth(Math.max(maxWidth, this.minItemWidth));
                item.setHeight(this.minItemHeight);
                menu.addItem(item);
            });
