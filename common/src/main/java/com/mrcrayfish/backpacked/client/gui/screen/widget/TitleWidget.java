...
public class TitleWidget extends AbstractWidget
{
    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick)
    {
        ...
        {
            TextureDefinitions.CHECKERS.draw(graphics, this.getX(), this.getY(), titleX - this.getX() - 3, this.font.lineHeight);
            TextureDefinitions.CHECKERS.draw(graphics, titleX + titleWidth + 3, this.getY(), this.getX() + this.getWidth() - titleX - titleWidth - 3, this.font.lineHeight);
        }
