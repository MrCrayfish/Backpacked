...
public class ClientRegistry
{
    ...
    private Map<String, ClientBackpack> backpacks = new HashMap<>();
    ...
    public void updateBackpacks(List<Backpack> backpacks)
    {
        ...
        backpacks.forEach(backpack -> {
            this.backpacks.put(backpack.getId().toString(), new ClientBackpack(backpack));
        });
    }

    @Nullable
    public ClientBackpack getBackpack(String id)
    {
        return this.backpacks.get(id);
    }

    @Nullable
    public ClientBackpack getBackpackOrDefault(String id)
    {
