 ...
 * Author: MrCrayfish
 */
public record ChallengeSerializer<T extends Challenge>(Identifier id, MapCodec<T> codec)
{
    public static final Codec<ChallengeSerializer<?>> CODEC = Identifier.CODEC.flatXmap(id -> {
        ...
        Identifier id = ChallengeManager.instance().getSerializerId(serializer);
