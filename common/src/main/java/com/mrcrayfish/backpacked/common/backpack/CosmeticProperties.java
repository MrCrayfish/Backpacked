 ...
 * Author: MrCrayfish
 */
public record CosmeticProperties(Optional<Identifier> cosmetic, boolean showWithElytra, boolean showEffects)
{
    ...
    public static final Codec<CosmeticProperties> CODEC = RecordCodecBuilder.create(builder -> builder.group(
        Identifier.CODEC.optionalFieldOf("cosmetic").forGetter(o -> o.cosmetic),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CosmeticProperties> STREAM_CODEC = StreamCodec.composite(
        Identifier.STREAM_CODEC.apply(ByteBufCodecs::optional), CosmeticProperties::cosmetic,
    ...
    public CosmeticProperties setCosmetic(Identifier model)
    {
