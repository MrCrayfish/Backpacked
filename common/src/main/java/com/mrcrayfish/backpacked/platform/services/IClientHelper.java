...
public interface IClientHelper
{
    ...
    void invokeRotationSetup(AvatarRenderer<AbstractClientPlayer> renderer, AbstractClientPlayer player, PoseStack stack, float scale, float bodyRot, float partialTick);
