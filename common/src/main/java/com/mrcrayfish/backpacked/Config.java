...
public class Config
{
    ...
    public static class Backpack
    {
        ...
        public static class Cosmetics
        {
            ...
            public final ListProperty<String> disabledCosmetics = ListProperty.create(ListProperty.STRING, new IdentifierValidator(""));
        }
    ...
    public static class Augments
    {
        ...
        public static class ImbuedHide
        {
            ...
            public final ListProperty<String> invulnerableToDamageTypes = ListProperty.create(ListProperty.STRING, new IdentifierValidator("Must be a valid damage type"), () -> List.of(
                DamageTypes.CACTUS.identifier().toString(),
                DamageTypes.EXPLOSION.identifier().toString(),
                DamageTypes.SONIC_BOOM.identifier().toString()
            ));
        }
