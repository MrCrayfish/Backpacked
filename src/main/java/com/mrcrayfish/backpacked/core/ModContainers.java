...
public class ModContainers
{
    ...
    public static final RegistryObject<ContainerType<BackpackContainer>> BACKPACK = register("backpack", (IContainerFactory<BackpackContainer>) (windowId, playerInventory, data) ->
            new BackpackContainer(windowId, playerInventory, data.readVarInt()));
