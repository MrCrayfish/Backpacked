...
public class ProgressFormatters
{
    ...
    public static final BiFunction<Integer, Integer, ITextComponent> CUT_X_OF_X = (count, unused) -> {
        return new TranslationTextComponent("backpacked.formatter.cut_x_of_x", count);
    };
