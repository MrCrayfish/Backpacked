...
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/entity/classic_backpack.png");

    public ClassicBackpackModel(ModelPart root)
    {
        super(root, TEXTURE);
    }
    ...
    public static LayerDefinition createLayer()
    {
        ...
        PartDefinition bag = backpack.addOrReplaceChild("bag", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, 0.0F, 0.0F, 7.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 13).addBox(-1.5F, 2.0F, 2.5F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -9.0F, 0.0F));
