...
public class ClientEvents
{
    ...
    private static void onAfterDrawBackground(AbstractContainerScreen<?> screen, PoseStack poseStack, int mouseX, int mouseY)
    {
    ...
    private static void repositionSlot(AbstractContainerScreen<?> screen, PoseStack poseStack, int mouseX, int mouseY)
    {
        if(Services.BACKPACK.isUsingThirdPartySlot())
            return;
